...
?>
<div class="woocommerce_order_items_wrapper wc-order-items-editable testing">
						...
						<table class="widefat">
							<thead>
								<tr>
									...
									<th><?php esc_html_e( 'Purpose', 'woocommerce' ); ?></th>
									<th><?php esc_html_e( 'Date of purchase', 'woocommerce' ); ?></th>
							...
							<?php
								$row = '
									...
									<td><input type="text" autocomplete="off" name="purpose" placeholder="Purpose" class="purpose" /></td>
									<td><input type="text" autocomplete="off" name="date_of_purchase" placeholder="Date of purchase" class="date_of_purchase date-picker" /></td>
